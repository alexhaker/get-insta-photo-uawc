...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'instaphp' => 'getInstaphpService',
            'instaphp_token_handler' => 'getInstaphpTokenHandlerService',
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_1e0f190a1b84e201347085a307a5915c26f97afc6783f3c107b7c0d25661bf2b');
    ...
    /**
     * Gets the 'instaphp' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Oh\InstagramBundle\Adapter\InstaphpAdapter A Oh\InstagramBundle\Adapter\InstaphpAdapter instance.
     */
    protected function getInstaphpService()
    {
        return $this->services['instaphp'] = new \Oh\InstagramBundle\Adapter\InstaphpAdapter($this->get('instaphp_token_handler'), array('client_id' => '25a2f0780ed642b489f9411783cc17cf', 'client_secret' => '09c9c6f55469419fa857b90723512b30', 'version' => 'v1', 'log_path' => ($this->targetDirs[2].'/logs/instaphp-dev.log'), 'endpoint' => 'https://api.instagram.com', 'scope' => 'comments+likes+relationships', 'oauth_path' => '/oauth/authorize/?client_id={client_id}&amp;response_type=code&amp;redirect_uri={redirect_uri}', 'oauth_token_path' => '/oauth/access_token/', 'redirect_route' => 'OhInstagramBundle_callback', 'no_verify_peer' => false, 'http_timeout' => 6, 'http_connect_timeout' => 2), $this->get('router'));
    }

    /**
     * Gets the 'instaphp_token_handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Oh\InstagramBundle\TokenHandler\CookieToken A Oh\InstagramBundle\TokenHandler\CookieToken instance.
     */
    protected function getInstaphpTokenHandlerService()
    {
        return $this->services['instaphp_token_handler'] = new \Oh\InstagramBundle\TokenHandler\CookieToken();
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/ollieltd/instagram-bundle/Oh/InstagramBundle/Resources/views'), 'OhInstagram');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ebe5ead682f23a33db0491b063bb1bcb5bc4a714');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('55f5c11927b3f3.85622428')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'OhInstagramBundle' => 'Oh\\InstagramBundle\\OhInstagramBundle',
            ...
            'secret' => 'ebe5ead682f23a33db0491b063bb1bcb5bc4a714',
            'instagram_api_client_id' => '25a2f0780ed642b489f9411783cc17cf',
            'instagram_api_client_secret' => '09c9c6f55469419fa857b90723512b30',
            ...
            'kernel.secret' => 'ebe5ead682f23a33db0491b063bb1bcb5bc4a714',
            ...
            'instaphp.config' => array(
                'client_id' => '25a2f0780ed642b489f9411783cc17cf',
                'client_secret' => '09c9c6f55469419fa857b90723512b30',
                'version' => 'v1',
                'log_path' => ($this->targetDirs[2].'/logs/instaphp-dev.log'),
